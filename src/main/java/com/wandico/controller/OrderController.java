...
import com.wandico.service.OrderDetailsService;
import com.wandico.service.TurnaAroundTimeService;
...
public class OrderController {
    ...
    public String empDelete(@ModelAttribute(value = "emp") OrderSurmmary emp, Map<String, Object> model) {
        ...
        if(emp.getQuantity() != 0) {
            ...
            orderSurmmary.setEstTurnaroundTime(turnaAroundTimeService.getTurnAroundTime(Optional.of(orderSurmmary)));
        }
